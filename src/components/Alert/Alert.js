...
export default class Alert extends PureComponent {
  ...
  render() {
    const { color, heading, message, icon } = this.props
    return (
      <div className={`flex bg-${color}-lighter max-w-sm mb-4`}>
        <div className={`w-16 bg-${color}`}>
          <div className="p-4">
            {icon === 'warning' && (
              <svg
        ...
        <div className="w-auto text-grey-darker items-center p-4">
          <span className="text-lg font-bold pb-4">{heading}</span>
